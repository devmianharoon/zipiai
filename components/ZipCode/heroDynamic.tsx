      ...
      <div className="container mx-auto ">
        ...
        <div className=" flex  justify-center items-center">
          <div className="w-[600px] text-center lg:mt-36 flex flex-col gap-8 mt-0 px-[15px] lg:mb-[120px] ">
            <h1 className="text-white  font-[var(--font-poppins)]">
        ...
        {/* Weather Section */}
        <div className="lg:w-[306px]  lg:h-[219px] lg:absolute lg:top-6 lg:right-6">
          {/* Loading and Error states */}
          {weatherState.status === "loading" && (
            <p className="text-white mt-4">Loading weather data...</p>
          )}
              ...
              {weatherState.data.forecast?.forecastday?.length > 0 ? (
                <div className="overflow-x-auto">
                  <div className="bg-red-400/30 backdrop-blur-sm rounded-xl p-5 my-8 ">
                    ...
                    <div className="border-b border-white/20 py-3 flex items-center justify-between">
                      <span className="font-medium text-white">Fri</span>
                      <Sun className="w-6 h-6 text-yellow-300" />
                      <span className="font-medium text-white">
                        48.7° | 71.4°
                      </span>

    ...
    return (
      <div className="relative w-full h-[500px] overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/assets/bg-directv-page.webp')",
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-4 z-10">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Bundle and Save, DirecTV Now</h1>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-redish">Beam it or Stream it</h2>
          <p className="text-xl md:text-2xl mb-8">Choose a DirecTV Package, Call Now for Special Offers</p>

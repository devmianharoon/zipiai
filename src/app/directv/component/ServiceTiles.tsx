  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-[#0a2540]">Choose which DIRECTV service works best for you.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-md border border-gray-200">
          ...
          <div className="p-6">
            <h2 className="text-2xl font-bold text-center mb-4">MyFree DIRECTV</h2>
            <ul className="space-y-2 mb-6">
              <li className="flex items-start">
                <span className="text-black mr-2">•</span>
                <span>A selection of popular channels that you can stream - for free!</span>
              </li>
              <li className="flex items-start">
                <span className="text-black mr-2">•</span>
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-md border border-gray-200">
          ...
          <div className="p-6">
            ...
            <ul className="space-y-2 mb-6">
              <li className="flex items-start">
                <span className="text-black mr-2">•</span>
                <span>Built to match the content you love, minus everything else</span>
              </li>
              <li className="flex items-start">
                <span className="text-black mr-2">•</span>
                <span>
                  Options include popular streaming services like ESPN+, Disney+, Hulu Bundle Basic and Max Basic With
                  Ads
                </span>
              </li>
              <li className="flex items-start">
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-md border border-gray-200">
          ...
          <div className="p-6">
            <h2 className="text-2xl font-bold text-center mb-4">Signature Packages</h2>
            <ul className="space-y-2 mb-6">
              <li className="flex items-start">
                <span className="text-black mr-2">•</span>
                <span>
                  Plans that include local/national sports, plus the entertainment and news you crave. Starting at
                  $84.99/mo. For 24 months + taxes and fees
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-black mr-2">•</span>
                <span>Up to 185 channels including premium network options</span>
              </li>
            </ul>
            <button className="w-full py-2 px-4 bg-[#0a2540] hover:bg-[#0a2540]/90 text-white font-medium rounded-md transition-colors">
              Shop now
      ...
      <div className="mt-12 bg-blue-500 rounded-lg overflow-hidden text-white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Pick the better way to watch it all</h2>
            <p className="mb-6">Stream all your content from your favorite apps in one place – no satellite needed.*</p>
            <div className="mb-6">
